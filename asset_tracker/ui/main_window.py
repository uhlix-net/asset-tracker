...
class MainWindow(QMainWindow):
    ...
    def _build_status_bar(self) -> None:
        ...
        self._status_count = sb.addWidget
        from PyQt6.QtWidgets import QLabel
        self._lbl_count = __import__("PyQt6.QtWidgets", fromlist=["QLabel"]).QLabel()
        self._lbl_values = __import__("PyQt6.QtWidgets", fromlist=["QLabel"]).QLabel()
